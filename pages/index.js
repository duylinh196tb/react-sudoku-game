...
const Description =
  "Discover the next evolution of Sudoku with amazing graphics, animations, and user-friendly features. Enjoy a Sudoku experience like you never have before with customizable game generation, cell highlighting, intuitive controls and more!";
const cellWidth = 2.5;
          ...
          {`
            ...
            .button {
              ...
              box-shadow: 0 2px 4px 0
                ${Color(backGroundBlue).darken(0.5).hsl().string()};
              display: flex;
              align-items: center;
            }
...
export default class Index extends Component {
  ...
  renderPuzzle() {
    const { board } = this.state;
    return (
      <div className="puzzle" style={{ backgroundColor: "#EDBB94" }}>
        {board
          .get("puzzle")
          .map((row, i) => (
  ...
  renderHeader() {
    return (
      <div className="header">
        <div
          className="new-game"
          onClick={() => this.setState({ board: false })}
        >
          <ReturnIcon />
